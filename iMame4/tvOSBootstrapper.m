 ...
 * gives permission to release a modified version without tvOShis exception;
...
-(void)applicationDidFinishLaunching:(NSNotification *)aNotification {
    ...
    isIpad = true;//[[Helper machine] rangeOfString:@"iPad"].location != NSNotFound;
    isIphone4 = false;//[[Helper machine] rangeOfString:@"iPhone3"].location != NSNotFound;
